/**
 * GET /api/inspect?token=<tok>&widget_id=<wid> — Debug inspection endpoint.
 */

import type { Env } from "../index.js";
import { validateToken } from "../auth/token.js";

export async function handleApiInspect(request: Request, env: Env): Promise<Response> {
  ...
  const doRes = await stub.fetch(new Request("https://do/inspect"));
